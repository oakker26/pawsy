      ...
      <div className='container bg-[#f6feff] lg:py-32 py-20'>
          <div className='flex flex-col lg:flex-row lg:justify-between justify-start items-center '>
              ...
              <div data-aos='fade-right'  data-aos-easing="ease-in-out"  data-aos-duration="1000" data-aos-delay="50" data-aos-once="false" className='flex items-center  space-x-2 mb-4 '>
                  ...
                  <h1 data-aos='fade-right'  data-aos-easing="ease-in-out"  data-aos-duration="1000" data-aos-delay="50" data-aos-once="false" className='md:text-5xl text-3xl font-bold'>Shop online and <span className='text-[#7d90e0]'>get 10% off</span></h1>
              </div>
              <div data-aos='fade-left'  data-aos-easing="ease-in-out"  data-aos-duration="1000" data-aos-delay="50" data-aos-once="false">
