...
import ProductThreeDes from './ProductThreeDes'

const ProductThreeHero = () => {
  return (
      ...
      <div className="flex-col  items-end  ">
        <div className=" relative w-[100%] mb-[-237px] rounded-2xl">
          <div className=" rounded-2xl relative  ">
                  ...
                  <img className='' src="https://assets.website-files.com/6107f3f9a7b00e6adf411dd2/613f21bcb7c57f404ef77585_Product%20Image%20Small.png" alt="" />
                              ...
                              <div className='col-span-12 lg:col-span-7 mt-12 lg:mt-0'>
                                  <h1 className='md:text-5xl text-2xl font-bold  text-[#1b2963]'>Premium Dog Food 3</h1>
                                  <p className=' font-[monsarret] mt-5 mb-8'>Available In Stock: <span className='text-[#1ba0ab]'>100 Items</span> </p>
                                  <h2 className='text-[#1b2963] text-3xl w-full md:w-auto text-center md:text-start font-bold p-6 bg-[#f9f9f9] inline-block rounded-2xl '>$ 12.00 USD <span className='text-xl line-through block md:inline'> $ 16.00 USD</span></h2>
...
export default ProductThreeHero