...
import ProductFourDes from './ProductFourDes'

const ProductFourHero = () => {
  return (
                      ...
                      <div className="grid grid-rows-1 p-10  bg-white rounded-2xl lg:grid-cols-1  ">
                          <div className='grid grid-cols-12    mt-5 md:gap-x-10  '>
                              <div className='p-2 relative border col-span-12 lg:col-span-5 flex justify-center items-center rounded-2xl'>
                                  <img className='' src="https://assets.website-files.com/6107f3f9a7b00e6adf411dd2/613f22044e41e24f40dcb6d4_Product%20Image%20Small.png" alt="" />
                              ...
                              <div className='col-span-12 lg:col-span-7 mt-12 lg:mt-0'>
                                  <h1 className='md:text-5xl text-2xl font-bold  text-[#1b2963]'>Premium Dog Food 4</h1>
...
export default ProductFourHero