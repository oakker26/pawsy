...
import ProductOneHero from './ProductTwoHero'
import ProductOneFooter from './ProductTwoFooter'
const ProductTwo = () => {
  return (
    <div className="">
    <div className='lg:mb-[480px]'>
            <div className=' min-h-[360px] overflow-hidden z-10 bg-[linear-gradient(180deg,#1b2963,#152154)] '>
              ...
              <div className=' bg-[#f6feff] relative z-10 container pr-0 flex pb-[300px] '>
