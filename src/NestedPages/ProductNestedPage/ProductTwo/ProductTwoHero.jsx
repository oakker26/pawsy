...
import ProductTwoDes from './ProductTwoDes'

const ProductTwoHero = () => {
  return (
      ...
      <div className="flex-col  items-end  ">
        <div className=" relative w-[100%] mb-[-237px] rounded-2xl">
          <div className=" rounded-2xl relative  ">
                  ...
                  <img className='' src=" https://assets.website-files.com/6107f3f9a7b00e6adf411dd2/613f21a28e1cad28361c7f86_Product%20Image%20Small.png" alt="" />
                              ...
                              <div className='col-span-12 lg:col-span-7 mt-12 lg:mt-0'>
                                  <h1 className='md:text-5xl text-2xl font-bold  text-[#1b2963]'>Premium Dog Food 2 </h1>
