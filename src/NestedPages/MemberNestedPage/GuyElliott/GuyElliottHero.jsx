      ...
      <div className=" container md:container relative overflow-hidden">
        ...
        <div className="grid grid-rows-1 mb-14 lg:grid-cols-12 mt-12 lg:px-24  ">
              <div className=" bg-white rounded-l-2xl  p-10 col-span-12 lg:col-span-4">
                          <div>
                              <img className='rounded-2xl' src="https://assets.website-files.com/6107f3f9a7b00e6adf411dd2/6138a22855f82a0c6469fb35_Team%20Image%205.png" alt="" />
                          </div>
                          <h5 className='text-2xl mb-3 font-semibold mt-8 text-[#1b2963]'>GuyElliott</h5>
