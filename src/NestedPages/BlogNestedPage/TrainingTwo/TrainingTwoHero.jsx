  ...
  return (
      ...
      <div className="  md:container lg:px-0 2xl:px-10 relative overflow-hidden">
                  ...
                  <div className="flex md:flex-row flex-col mt-8 lg:px-14 justify-between items-center  lg:mt-16">
                      <h1 className='text-white text-3xl text-center md:text-start mb-7 md:mb-0 md:text-5xl font-semibold'>What You Need to<br /> <span className='md:mt-4 mt-12 lg:inline-block'> Know Before Start</span> <br /> <span className='md:mt-4 mt-12 lg:inline-block'>Training Dog</span></h1>
          <div className="flex justify-center p-4 text-white bg-[#ffffff22] rounded-full items-center">
            ...
            <p className="opacity-50">September 29, 2021</p>
          </div>
        </div>
        <div className="grid grid-rows-1 mb-20 lg:grid-cols-1  mt-12 lg:px-14 2xl:container  ">

                      <div className=' h-[500px]  rounded-2xl '>
                     <img className=' rounded-3xl h-[500px] w-full object-cover' src="https://assets.website-files.com/6107f3f9a7b00e6adf411dd2/612f956ab0d5b9e0626b841f_1630508393910-image19.jpg" alt="" />
                      </div>        
...
export default TrainingTwoHero