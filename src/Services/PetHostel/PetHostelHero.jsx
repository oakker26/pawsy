        ...
        <div className=" relative w-[100%] mb-[-237px] rounded-2xl">
          <div className=" rounded-2xl relative  ">
            <div className="grid grid-rows-1 lg:grid-cols-12  ">
              <div className=" bg-white rounded-l-2xl  py-10 px-10 col-span-12 lg:col-span-3">
                <div>
                ...
                <div className="border-l p-10">
                  <div className="flex items-center mb-10 space-x-10">
                    <div className="w-16 h-16 flex items-center justify-center rounded-full bg-[#f9f9f9]">
                      <img
                        src="https://assets.website-files.com/6107f3f9a7b00e6adf411dd2/613664a45fa4d561abded287_Pet%20Hostel.png"
                        alt=""
                      />
                    </div>
